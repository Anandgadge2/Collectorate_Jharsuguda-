...
const Contact = () => {
  return (
    <PageLayout title="Contact Us" subtitle="Get in touch with the District Administration">
          ...
          <div className="contact-info-panel">
            ...
            <div className="card location-card">
              <div className="address-block">
                ...
                <p>NH 10, Jharsuguda Road, Bijju Nagar</p>
                <p>Jharsuguda, Odisha 768204</p>
              </div>
              
              <div className="contact-details">
                <div className="detail-item">
                  <strong>Phone:</strong>
                  <span>06645-270070 / 8093178590</span>
                </div>
                <div className="detail-item">
                  <strong>Email:</strong>
                ...
                <div className="detail-item">
                  ...
                  <span>10:00 AM – 5:30 PM (Mon-Sat, 2nd & 4th Sat Holidays)</span>
                </div>
              </div>
            </div>
